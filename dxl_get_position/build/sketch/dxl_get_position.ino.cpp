#include <Arduino.h>
#line 1 "C:\\Users\\Utente\\Desktop\\RCR-master\\dxl_get_position\\dxl_get_position.ino"
...
#line 45 "C:\\Users\\Utente\\Desktop\\RCR-master\\dxl_get_position\\dxl_get_position.ino"
void setup();
#line 127 "C:\\Users\\Utente\\Desktop\\RCR-master\\dxl_get_position\\dxl_get_position.ino"
void loop();
#line 45 "C:\\Users\\Utente\\Desktop\\RCR-master\\dxl_get_position\\dxl_get_position.ino"
void setup() {
  ...
  //dxl.begin_dxl(BaudRateDXL);
  mot_Left_1.begin_dxl(BaudRateDXL);
  mot_Right_1.begin_dxl(BaudRateDXL);
  mot_2.begin_dxl(BaudRateDXL);
  mot_3.begin_dxl(BaudRateDXL);
  mot_4.begin_dxl(BaudRateDXL);
  mot_5.begin_dxl(BaudRateDXL);
  mot_6.begin_dxl(BaudRateDXL);
